 <FORM><INPUT Type="BUTTON" VALUE="Add user" ONCLICK="window.location.href='admin-addUser.php'"> </FORM>
 <FORM><INPUT Type="BUTTON" VALUE="Add product" ONCLICK="window.location.href='admin-addProducts.php'"> </FORM>
 <FORM><INPUT Type="BUTTON" VALUE="Edit a product" ONCLICK="window.location.href='admin-Products.php'"> </FORM>
